...
export default function Card({ product }) {
  return (
    <Link
      ...
      className="flex flex-col max-w-[370px] flex-wrap p-[16px] bg-[#000000] hover:ring-opacity-40 active:ring-5 active:ring-[#6247eb] hover:ring-4 active:ring-2 active:ring-opacity-90"
    >
      <div className="flex flex-col max-w-[370px] flex-wrap p-[16px] bg-[#000000]">
        <img
          src={product.imageUrl ?? ""}
          alt={product.name ?? "No name"}
          className="block max-h-[200px] mb-4 object-cover"
        />
          ...
          <div>
            {product.stock <= 0 ? (
              ...
              <>
                ...
                <Button
                  type="button"
                  className="inline-flex items-center justify-center gap-2 p-4 bg-[#ffffff] text-center hover:bg-[#5969cf] text-black active:bg-[#4956ab]"
                >
                  <FontAwesomeIcon icon={faCartShopping} className="mb-0" />
                  <span>Sewa Badut</span>
                </Button>
              </>
            ) : (
              <Button
